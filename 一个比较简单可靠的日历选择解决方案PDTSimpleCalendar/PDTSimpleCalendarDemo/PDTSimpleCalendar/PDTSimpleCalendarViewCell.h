...
/**
 *  Customize the separator color between the dates.
 */
@property (nonatomic, strong) UIColor *separatorColor UI_APPEARANCE_SELECTOR;

/**
 *  Customize the local day's number using UIAppearance.
 */
@property (nonatomic, strong) UIColor *subTextDefaultColor UI_APPEARANCE_SELECTOR;
