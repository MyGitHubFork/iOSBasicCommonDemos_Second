...
-(void)setUI
{
    ...
    _imageView.center = CGPointMake(SCREEN_WIDTH - 80, SCREEN_HEIGHT - 20);
    [self.view addSubview:_imageView];
    
    
    // label
    _cntLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 20, 20)];
    ...
    [_imageView addSubview:_cntLabel];
    ...
    [_path moveToPoint:CGPointMake(SCREEN_WIDTH - 10, SCREEN_HEIGHT - 10)];
    [_path addQuadCurveToPoint:CGPointMake(_imageView.center.x, _imageView.center.y) controlPoint:CGPointMake(SCREEN_WIDTH - 50, SCREEN_HEIGHT - 100)];
}
-(void)startAnimation
{
    if (!layer)
    {
        ...
        layer.position =CGPointMake(SCREEN_WIDTH, SCREEN_HEIGHT);
